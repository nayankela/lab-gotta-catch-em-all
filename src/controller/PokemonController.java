...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			Bulbasaur bulbasaur = new Bulbasaur("Bulbasaur", 001,
		...
		if (value2 != null) {
			...
			Charizard charizard = new Charizard("Charizard", 006,
		...
		if (value3 != null) {
			...
			Dragonite dragonite = new Dragonite("Dragonite", 149,
		...
		if (value5 != null) {
			...
			Pikachu pikachu = new Pikachu("Pikachu", 25,
